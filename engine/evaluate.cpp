...
// Returns bitmask of squares adjacent to and including the king's file
...
// Rewards pawns sheltering the king, penalises open files near the king. Score is from the perspective of `colour`.
static int kingSafety(Board& board, int colour) {
    ...
    // Pawn shield: friendly pawns in the two ranks in front of the king
    ...
    // Open / half-open file penalty near king
...
// ─── Main evaluation (positive = good for WHITE) ─────────────────────────────
